import { validateHandle as validateHandleShared } from '@receiptsplit/shared';
...
/** Re-export from shared (3–20 chars, lowercase/numbers/underscore) */
export const validateHandle = validateHandleShared;
